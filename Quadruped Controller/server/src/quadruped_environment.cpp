...
void QuadrupedEnvironment::onInit()
{
    ...
    m_frontLeft.init(word, space, {0, 0, 0});
    // m_frontLeft.init(word, space, {-2.25, 0, -1});
    // m_backLeft.init(word, space, {2.25, 0, -1});
    // m_backRight.init(word, space, {2.25, 0, 1});
    // m_frontRight.init(word, space, {-2.25, 0, 1});
...
void QuadrupedEnvironment::onSimulate(float timeStep)
{
    ...
    m_frontLeft.state.generateBinaryStream();
